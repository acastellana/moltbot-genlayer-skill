...
GenLayer is a decentralized protocol where multiple LLMs reach consensus on complex tasks and decisions—the first AI-native blockchain. Use this skill when working on anything related to GenLayer, Rally, or the broader ecosystem.

## When to Use

- Explaining GenLayer to investors, developers, or partners
- Writing about the protocol, architecture, or vision
- Helping with Intelligent Contracts development
...
| Concept | Description |
|---------|-------------|
| **Intelligent Contracts** | AI-powered smart contracts written in Python that can reason, access web data, and handle non-deterministic operations |
...
- `thesis.md` — The philosophical thesis: trust, AI, and why GenLayer exists
- `architecture.md` — Technical components and how they work together
- `consensus.md` — Optimistic Democracy, Equivalence Principle, appeals
- `intelligent-contracts.md` — Developer guide to Intelligent Contracts
